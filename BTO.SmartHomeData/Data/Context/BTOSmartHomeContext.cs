...
namespace BTO.SmartHomeData.Data.Context
{
    public class BTOSmartHomeContext : DbContext
    {
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder.UseSqlServer("Data Source=PC_ORCUNTEN; Initial Catalog=; Persist Security Info=True; Integrated Security=SSPI;pooling=true;");

        }


        public DbSet<t_Sensors> t_Sensors { get; set; }
